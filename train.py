...
if __name__ == '__main__':
    ...
    parser.add_argument('--epoch', type=int, default=400, help='epoch number') #修改这里！！！
    ...
    parser.add_argument('--save_path', type=str,
                        default='/root/autodl-tmp/LCD-Net/LCD-Net/output/')
    ...
    if opt.data_name == 'LEVIR':
        opt.train_root = '/root/autodl-tmp/ChangeNet/datasets/LEVIR-CD+/train/'
        opt.val_root = '/root/autodl-tmp/ChangeNet/datasets/LEVIR-CD+/test/'
    elif opt.data_name == 'SYSU':
        opt.train_root = "/root/autodl-tmp/ChangeNet/datasets/SYSU-CD/train/"
        opt.val_root = "/root/autodl-tmp/ChangeNet/datasets/SYSU-CD/test/"
    elif opt.data_name == 'S2Looking':
        opt.train_root = '/root/autodl-tmp/ChangeNet/datasets/S2Looking/train/'
        opt.val_root = '/root/autodl-tmp/ChangeNet/datasets/S2Looking/test/'
